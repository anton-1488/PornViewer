...
public record PVFileManager() {
    ...
    private static final Logger log = LoggerFactory.getLogger(PVFileManager.class);
    ...
    public static @NonNull String guessMimeType(Path filename, String defaultType) {
        try {
            return Files.probeContentType(filename);
        } catch (IOException e) {
